...
$(document).ready(function() {
    $('input[name="fancy_slider_style"]').change(function() {
        ...
        if (selectedStyles === 'sliderstyle1') {
            ...
            $('#fpg_button_hover_background_color').val(''); 
            $('#fpg_button_text_color').val('#000000'); 
            $('#fpg_button_text_hover_color').val('#ff7b18');
            $('#fpg_button_border_color').val('');
            $('#fpg_button_margin').val('');
            $('#fpg_button_padding').val(''); 
            $('#fpg_button_font_size').val('16px');
            $('#fpg_button_font_weight').val('100');
            $('#fancy_button_border_style').val('unset');

            $('#fpg_slider_dots_color').val(''); 
            $('#fpg_slider_dots_active_color').val('');
            $('#fpg_arrow_color').val(''); 
            $('#fpg_arrow_hover_color').val('');
            $('#fpg_arrow_bg_color').val('');
            $('#fpg_arrow_bg_hover_color').val('');
            $('#fpg_icon_font_size').val(''); 
            $('#fpg_fraction_total_color').val('');
            $('#fpg_fraction_current_color').val('');
            $('#fpg_fraction_total_font_size').val('');
            $('#fpg_fraction_current_font_size').val('');
            $('input[name="fancy_post_main_box_alignment"][value="align-start"]').prop('checked', true).change();
            $('#fancy_button_option').val('border').change();
            $('#fancy_post_hover_animation').val('zoom_in').change();
            $('#fancy_post_image_border_radius').val('');
        ...
        $('#fpg_slider_dots_color').change();
        $('#fpg_slider_dots_active_color').change();
        $('#fpg_arrow_color').change();
        $('#fpg_arrow_hover_color').change();
        $('#fpg_arrow_bg_color').change();
        $('#fpg_arrow_bg_hover_color').change();
        $('#fpg_icon_font_size').change();
        $('#fpg_fraction_total_color').change();
        $('#fpg_fraction_current_color').change();
        $('#fpg_fraction_total_font_size').change();
        $('#fpg_fraction_current_font_size').change(); 
        $('#fancy_button_option').change();
        $('#fancy_post_hover_animation').change();
        $('#fancy_post_feature_image_size').change();
        $('#fancy_post_image_border_radius').change();
