...
if ($query->have_posts()) {
    echo '<div class="fpg-section-area rs-blog-layout-22">';
    ...
    ?>
        <div class="col-md-6">
            ...
            ?>
            <div class="rs-blog-layout-22-item align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
