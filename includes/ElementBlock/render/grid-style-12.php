...
if ($query->have_posts()) {
    echo '<div class="fpg-section-area rs-blog-layout-26">';
    echo '<div class="row">';
    ...
    ?>
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop']); ?> 
            ...
            ?>
            <div class="rs-blog__single rs-blog-layout-26-item align-<?php echo esc_attr($box_alignment); ?> fancy-post-item mt-30 <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
