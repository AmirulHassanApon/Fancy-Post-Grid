        ...
        <div class="swiper fancy-swiper-slider">
            <div class="swiper-wrapper">
                ...
                while ($query->have_posts()) {
                    ...
                    $col_class = isset($settings['col_desktop_slider']) ? esc_attr($settings['col_desktop_slider']) : '';
                    ...
                    echo '<div class="swiper-slide fancy-post-item col-' . esc_attr($col_class) . '" style="background-color: ' . esc_attr($background_color) . '; text-align: ' . esc_attr($text_alignment) . '; padding: ' . esc_attr($padding) . '; border-radius: ' . esc_attr($border_radius) . ';gap: ' . esc_attr($gap) . ';">';
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            new Swiper('.fancy-swiper-slider', {
                loop: <?php echo $settings['enable_looping'] === 'yes' ? 'true' : 'false'; ?>,
                autoplay: <?php echo $settings['auto_play_speed'] > 0 ? '{ delay: ' . intval($settings['auto_play_speed']) . ', disableOnInteraction: false }' : 'false'; ?>,
                navigation: {
                ...
                pagination: {
                    ...
                    type: '<?php echo $settings['slider_pagination_type']; ?>',
                    clickable: <?php echo $settings['pagination_clickable_mode'] === 'yes' ? 'true' : 'false'; ?>,
                },
                keyboard: {
                    enabled: <?php echo $settings['enable_keyboard_control'] === 'yes' ? 'true' : 'false'; ?>,
                },
                freeMode: <?php echo $settings['enable_free_mode'] === 'yes' ? 'true' : 'false'; ?>,
                slidesPerView: <?php echo !empty($settings['slider_columns']) ? intval($settings['slider_columns']) : 3; ?>,
                spaceBetween: <?php echo !empty($settings['slider_item_gap']) ? intval($settings['slider_item_gap']) : 10; ?>,
            });
        });
    </script>
    <?php
