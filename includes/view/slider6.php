...
<style type="text/css">
    ...
    /* Single Item Styles */
    .rs-blog-layout-23 .rs-blog-layout-23-item{
    ...
    /* Button Styles */
    .rs-blog-layout-23-item .rs-blog-layout-23-overlay .rs-btn.<?php echo esc_attr($button_class); ?>{
    ...
    .rs-blog-layout-23-item .rs-blog-layout-23-overlay .rs-btn-box{
        <?php if (!empty($fpg_button_order)) : ?>
            order: <?php echo esc_attr($fpg_button_order); ?>;
        <?php endif; ?>

    }
    .rs-blog-layout-23-item .rs-blog-layout-23-overlay .rs-btn.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .rs-blog-layout-23-item .rs-blog-layout-23-overlay .rs-btn.<?php echo esc_attr($button_class); ?>::before{
        
        <?php if (!empty($fpg_primary_color) || !empty($fpg_button_border_color)) : ?>
            background: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fpg_button_border_color); ?>;
        <?php endif; ?>
    }

    .rs-blog-layout-23 .swiper_wrap .swiper-pagination-progressbar,
    .rs-blog-layout-23 .swiper_wrap .swiper-pagination .swiper-pagination-bullet{
    ...
    .rs-blog-layout-23 .swiper_wrap .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active{
    ...
    .rs-blog-layout-23 .swiper_wrap .swiper-button-next:hover,
    .rs-blog-layout-23 .swiper_wrap .swiper-button-prev:hover{
...
.rs-blog-layout-23 .swiper_wrap .swiper-button-next:hover::after,
.rs-blog-layout-23 .swiper_wrap .swiper-button-prev:hover::after{
    <?php if (!empty($fpg_arrow_hover_color)) : ?>
        color: <?php echo esc_attr($fpg_arrow_hover_color); ?>;
    <?php endif; ?>
}

.rs-blog-layout-23 .swiper_wrap .swiper-pagination-fraction{
...
.rs-blog-layout-23 .swiper_wrap .swiper-pagination-fraction .swiper-pagination-current{
