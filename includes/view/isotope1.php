...
?>
<!-- isotope 1 -->
<section class="rs-blog-layout-4 rs-blog-layout-10 grey"style="
        ...
        <div class="row rs-grid">
            ...
            ?>
                ...
                <div class=" <?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?> rs-grid-item
                    ...
                    <div class="rs-blog__item <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>" style="
                            ...
                            <div class="rs-blog-footer">
                                <span>
                                    ...
                                    <?php if ($fpg_field_group_comment_count ) : ?>
                                        <div class="meta-comment-count" style="<?php if (!empty($fpg_meta_color)) : ?>
