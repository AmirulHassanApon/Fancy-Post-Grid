...
?>
<!-- isotope 3 -->
<section class="rs-blog-layout-28 rs-blog-layout-10">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="rs-blog-layout-3-filter" style="justify-content: <?php echo esc_attr($fancy_post_filter_alignment); ?>;">
        ...
        <div class="row rs-grid">
            ...
            <div class=" <?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?> rs-grid-item
                ...
                <div class="rs-blog-layout-28-item <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>">
...
<style type="text/css">
    ...
    .rs-blog-layout-28 .rs-blog-layout-3-filter .filter-button-group{
        ...
        <?php if (!empty($fpg_primary_color) || !empty($fancy_post_filter_box_bg_color)) : ?>
            background: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fancy_post_filter_box_bg_color); ?>;
        <?php endif; ?>
    ...
    .rs-blog-layout-28 .rs-blog-layout-3-filter .filter-button-group button:hover{
        ...
        <?php if (!empty($fpg_primary_color) || !empty($fancy_post_filter_hover_color)) : ?>
            color: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fancy_post_filter_hover_color); ?>;
        <?php endif; ?>
    }

    .rs-blog-layout-28 .rs-blog-layout-3-filter .filter-button-group button.active{
        
        <?php if (!empty($fpg_primary_color) || !empty($fancy_post_filter_active_color)) : ?>
            color: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fancy_post_filter_active_color); ?>;
        <?php endif; ?>
    ...
    .rs-blog-layout-28 .rs-blog-layout-3-filter .filter-button-group button:hover{
        ...
        <?php if (!empty($fpg_primary_color) || !empty($fancy_post_filter_active_border_color)) : ?>
            border-color: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fancy_post_filter_active_border_color); ?>;
        <?php endif; ?>
    }
    /* Single Item Styles */
    .rs-blog-layout-28 .rs-grid .rs-grid-item.rs-blog-layout-28-item {
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb{
        <?php if (!empty($fancy_post_image_border_radius)) : ?>
            border-radius: <?php echo esc_attr($fancy_post_image_border_radius); ?>;
        <?php endif; ?>
    }
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content {
    ...
    /* Title Styles */
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .title {
    ...
    /* Title Styles */
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .title a {
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .title a:hover {
    ...
    /* Excerpt Styles */
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .fpg-excerpt {
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .fpg-excerpt p{
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .btn-wrapper{
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28 .rs-blog__single .rs-content ul{
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb .rs-meta{
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb .rs-meta::before{
        <?php if (!empty($fpg_primary_color) || !empty($fpg_meta_bgcolor)) : ?>
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb .rs-meta ul li a,
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb .rs-meta ul li {
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-thumb .rs-meta ul li::after{
        <?php if (!empty($fpg_meta_color)) : ?>
            color: <?php echo esc_attr($fpg_meta_color); ?>;
        <?php endif; ?>
    }
    ...
    /* Button Styles */
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>{
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .rs-blog-layout-28 .rs-grid .rs-grid-item .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>::before{
