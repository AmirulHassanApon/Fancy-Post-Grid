                                    ...
                                    <div class="blog-content">
                                        ...
                                        <?php if ($fpg_field_group_excerpt) : ?>
                                            <div class="desc <?php echo esc_attr($excerpt_alignment_class); ?>">
                                                <p><?php echo esc_html(wp_trim_words(get_the_content(), $fancy_post_excerpt_limit, $excerpt_more_text)); ?></p>
                                            </div>
                                        <?php endif; ?>
...
<style type="text/css">
    ...
    .rs-blog-layout-1 .blog-item .blog-content .blog-meta li i,
    ...
    .rs-blog-layout-1 .blog-item .blog-content .blog-btn .read-more.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .rs-blog-layout-1 .blog-item .blog-content .blog-btn .read-more.<?php echo esc_attr($button_class); ?>::before{
    ...
    .rs-blog-layout-1 .swiper_wrap .swiper-button-next:hover,
    .rs-blog-layout-1 .swiper_wrap .swiper-button-prev:hover{
...
.rs-blog-layout-1 .swiper_wrap .swiper-button-next:hover::after,
.rs-blog-layout-1 .swiper_wrap .swiper-button-prev:hover::after{
    <?php if (!empty($fpg_arrow_hover_color)) : ?>
        color: <?php echo esc_attr($fpg_arrow_hover_color); ?>;
    <?php endif; ?>
}

.rs-blog-layout-1 .swiper_wrap .swiper-pagination-fraction{
...
.rs-blog-layout-1 .swiper_wrap .swiper-pagination-fraction .swiper-pagination-current{
