...
<div class="rs-blog-layout-1" style="
                                ...
                                <div class="blog-item" style="
                                    ...
                                    <div class="blog-content" style="
                                        ...
                                        <ul class="blog-meta <?php echo esc_attr($meta_alignment_class); ?>" style ="
                                            ...
                                            <?php if ($fpg_field_group_post_date) : ?>
                                                ...
                                                <?php endif; ?>">
                                                    ...
                                                    <i class="ri-calendar-2-line" style="
                                            ...
                                            <?php if ($fpg_field_group_categories) : ?>
                                                <i class="ri-folder-line" style="<?php if (!empty($fpg_meta_color)) : ?>
                                                    color: <?php echo esc_attr($fpg_meta_color); ?>;
                                                <?php endif; ?>
                                                <?php if (!empty($fpg_meta_size)) : ?>
                                                    font-size: <?php echo esc_attr($fpg_meta_size); ?>px;
                                            ...
                                            <?php if ($fpg_field_group_comment_count && get_comments_number() > 0) : ?>
                                                <li class="meta-comment-count" style="<?php if (!empty($fpg_meta_color)) : ?>
                                                    color: <?php echo esc_attr($fpg_meta_color); ?>;
                                                <?php endif; ?>
                                                <?php if (!empty($fpg_meta_size)) : ?>
                                                    font-size: <?php echo esc_attr($fpg_meta_size); ?>px;
                                                ...
                                                <?php if (!empty($fpg_meta_font_weight)) : ?>
                                                    font-weight: <?php echo esc_attr($fpg_meta_font_weight); ?>;
                                                <?php endif; ?>">
                                                    <i class="ri-chat-3-line" style="<?php if (!empty($fpg_meta_color)) : ?>
                                                    color: <?php echo esc_attr($fpg_meta_color); ?>;
                                                <?php endif; ?>
                                                <?php if (!empty($fpg_meta_size)) : ?>
                                                    font-size: <?php echo esc_attr($fpg_meta_size); ?>px;
                                            ...
                                            <?php if ($fpg_field_group_tag && has_tag()) : ?>
                                                <li class="meta-tags" style="<?php if (!empty($fpg_meta_color)) : ?>
                                                    color: <?php echo esc_attr($fpg_meta_color); ?>;
                                                <?php endif; ?>
                                                <?php if (!empty($fpg_meta_size)) : ?>
                                                    font-size: <?php echo esc_attr($fpg_meta_size); ?>px;
                                                ...
                                                <?php if (!empty($fpg_meta_font_weight)) : ?>
                                                    font-weight: <?php echo esc_attr($fpg_meta_font_weight); ?>;
                                                <?php endif; ?>">
                                                    <i class="ri-price-tag-3-line" style="<?php if (!empty($fpg_meta_color)) : ?>
                                                    color: <?php echo esc_attr($fpg_meta_color); ?>;
                                                <?php endif; ?>
                                                <?php if (!empty($fpg_meta_size)) : ?>
                                                    font-size: <?php echo esc_attr($fpg_meta_size); ?>px;
                                        ...
                                        <?php if ($fpg_field_group_title) : ?>
                                            <<?php echo esc_attr($title_tag); ?> class="blog-title" style="
