...
<style type="text/css">
    ...
    /* Single Item Styles */
    .rs-blog-layout-28 .rs-blog-layout-28-item{
    ...
    .rs-blog-layout-28 .rs-blog-layout-28-item .rs-content {
    ...
    .rs-blog-layout-28-item .rs-content p.desc{
    ...
    .rs-blog-layout-28-item .rs-thumb .rs-meta::before {
        ...
        <?php if (!empty($fpg_meta_bgcolor)) : ?>
            border-bottom: <?php echo esc_attr($fpg_meta_bgcolor); ?>;
        <?php endif; ?>
    ...
    .rs-blog-layout-28-item .rs-thumb .rs-meta ul li::after{
        <?php if (!empty($fpg_meta_color)) : ?>
            color: <?php echo esc_attr($fpg_meta_color); ?>;
        <?php endif; ?>
    }
    .rs-blog-layout-28-item .rs-thumb .rs-meta ul li:hover, 
    .rs-blog-layout-28-item .rs-thumb .rs-meta ul li a:hover{
    ...
    /* Button Styles */
    .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>{
    ...
    .rs-blog-layout-28-item .rs-content .rs-btn-box{
        <?php if (!empty($fpg_button_order)) : ?>
            order: <?php echo esc_attr($fpg_button_order); ?>;
        <?php endif; ?>

    }
    .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .rs-blog-layout-28-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>::before{
    ...
    .rs-blog-layout-28 .swiper_wrap .swiper-pagination .swiper-pagination-bullet{
        <?php if (!empty($fpg_slider_dots_color)) : ?>
            background: <?php echo esc_attr($fpg_slider_dots_color); ?>;
        <?php endif; ?>
    }
    .rs-blog-layout-28 .swiper_wrap .swiper-pagination-progressbar .swiper-pagination-progressbar-fill,
    .rs-blog-layout-28 .swiper_wrap .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active{
    ...
    .rs-blog-layout-28 .swiper_wrap .swiper-button-next:hover,
    .rs-blog-layout-28 .swiper_wrap .swiper-button-prev:hover{
...
.rs-blog-layout-28 .swiper_wrap .swiper-button-next:hover::after,
.rs-blog-layout-28 .swiper_wrap .swiper-button-prev:hover::after{
    <?php if (!empty($fpg_arrow_hover_color)) : ?>
        color: <?php echo esc_attr($fpg_arrow_hover_color); ?>;
    <?php endif; ?>
}

.rs-blog-layout-28 .swiper_wrap .swiper-pagination-fraction{
...
.rs-blog-layout-28 .swiper_wrap .swiper-pagination-fraction .swiper-pagination-current{
