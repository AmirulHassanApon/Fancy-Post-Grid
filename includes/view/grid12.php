...
<style type="text/css">
    ...
    .rs-blog-layout-26 .rs-blog-layout-26-item{
    ...
    .rs-blog-layout-26-item:hover .rs-content .rs-btn.<?php echo esc_attr($button_class); ?> {
    ...
    .rs-blog-layout-26-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>::before{
