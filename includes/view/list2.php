...
?>
<!-- ==== Blog Grid Layout 2 ==== -->
<section class="rs-blog-layout-1 rs-blog-layout-9" style="
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-lg-6 md-mb-50">
                    ...
                    <div class="blog-item <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>" style="
                ...
                <div class="col-lg-6">
                    <div class="blog-horizontal">
                        ...
                        <div class="blog-meta mb-30">
                            <div class="blog-item-wrap <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>" style="
                            <?php if (!empty($fpg_single_section_background_color)) : ?>
                                background-color: <?php echo esc_attr($fpg_single_section_background_color); ?>;
                            <?php endif; ?>
                            <?php if (!empty($fpg_single_section_margin)) : ?>
