    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="<?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?>">
                <div class="rs-blog-layout-21-item <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>" >                   
...
<style type="text/css">
    ...
    /* Single Item Styles */
    .rs-blog-layout-21 .rs-blog-layout-21-item {
    ...
    .rs-blog-layout-21 .rs-blog-layout-21-item .rs-content {
    ...
    /* Title Styles */
    .rs-blog-layout-21 .rs-blog-layout-21-item .rs-content .title {        
    ...
    /* Title Styles */
    .rs-blog-layout-21 .rs-blog-layout-21-item .rs-content .title a {
    ...
    .rs-blog-layout-21 .rs-blog-layout-21-item .rs-content .title a:hover {
    ...
    .rs-blog-layout-21 .rs-blog-layout-21-item .rs-content .btn-wrapper{
    ...
    .rs-blog-layout-21-item .rs-content .rs-meta ul li svg line{
        
        <?php if (!empty($fpg_primary_color) || !empty($fpg_meta_color)) : ?>
            stroke: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fpg_meta_color); ?>;
        <?php endif; ?>      
    }
    
    .rs-blog-layout-21-item .rs-content .rs-meta ul li a:hover{
    ...
    /* Button Styles */
    .rs-blog-layout-21-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>{
    ...
    .rs-blog-layout-21-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .rs-blog-layout-21-item .rs-content .rs-btn.<?php echo esc_attr($button_class); ?>::before{
